    ...
    <div className="flex h-full flex-col">
      ...
      <div className="flex flex-col md:flex-row min-h-0 flex-1">
        ...
        {isLeftPanelOpen && currentLectureId && (
          <div className="fixed inset-x-0 bottom-0 z-40 flex h-[75dvh] w-full flex-col rounded-t-2xl border-t border-gray-200 bg-white shadow-2xl md:relative md:inset-auto md:h-full md:w-[360px] md:rounded-none md:border-t-0 md:border-r md:shadow-none shrink-0 dark:border-gray-700 dark:bg-gray-900">
        ...
        {isChatPanelOpen && (
          <div className="fixed inset-x-0 bottom-0 z-40 flex h-[75dvh] w-full flex-col rounded-t-2xl border-t border-gray-200 bg-white shadow-2xl md:relative md:inset-auto md:h-full md:w-[360px] md:rounded-none md:border-t-0 md:border-l md:shadow-none shrink-0 dark:border-gray-700 dark:bg-gray-900">
            <div className="flex shrink-0 items-center justify-between border-b border-gray-200 px-3 py-2 dark:border-gray-700">
