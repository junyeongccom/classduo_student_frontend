...
export function SelectedTestInfoCard({ test, onStart }: SelectedTestInfoCardProps) {
  ...
  return (
    <div className="relative flex min-h-[200px] items-stretch justify-between gap-6 overflow-hidden rounded-3xl border border-gray-200 bg-white px-7 py-7 dark:border-gray-700 dark:bg-gray-900">
