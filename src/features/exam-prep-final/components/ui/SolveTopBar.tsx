...
export function SolveTopBar({
  ...
  return (
    <header className="flex shrink-0 items-center justify-between border-b border-gray-200 bg-white px-6 py-3 dark:border-gray-700 dark:bg-gray-900">
      <nav className="flex min-w-0 items-center gap-2 text-sm font-medium text-gray-400">
        <Link
      ...
      <button
        type="button"
        onClick={onExit}
        className="shrink-0 rounded-lg border border-gray-300 bg-white px-3.5 py-1.5 text-sm font-semibold text-gray-700 transition-colors hover:bg-gray-50 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-700"
      >
