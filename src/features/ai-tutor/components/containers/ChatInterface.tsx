                          ...
                          <div className="flex items-start gap-3 px-4 py-3 bg-white rounded-lg border border-gray-200">
                            <div className="flex-shrink-0 mt-0.5">
                              <div className="w-9 h-9 rounded-full bg-gray-100 border border-gray-200 flex items-center justify-center">
                                <span className="text-gray-500 dark:text-gray-400 text-base">🎙️</span>
                              </div>
                            </div>
                            <div className="flex-1 min-w-0">
                              <p className="text-sm font-medium text-gray-500 dark:text-gray-400">{t('recordingSourceDisabled')}</p>
                              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">{t('sourceLabels.recording')}</p>
                            </div>
                          </div>
                        ) : (
                          <>
