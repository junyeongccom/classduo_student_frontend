...
import { S, METEOR_SIZE } from "../constants";
...
export class Meteor extends Phaser.Physics.Arcade.Sprite {
  ...
  constructor(scene: Phaser.Scene, x: number, y: number) {
    ...
    this.setDisplaySize(METEOR_SIZE, METEOR_SIZE);
  ...
  preUpdate(time: number, delta: number): void {
    ...
    this.trail.fillCircle(this.x, this.y, METEOR_SIZE * 0.6);
    this.trail.fillStyle(0xffaa00, 0.08);
    this.trail.fillCircle(this.x, this.y, METEOR_SIZE * 0.45);
