...
export default function manifest(): MetadataRoute.Manifest {
  return {
    ...
    theme_color: '#0C244A',
    icons: [
      { src: '/HAI_Sync_favicon.png', sizes: '192x192', type: 'image/png', purpose: 'any' },
      { src: '/HAI_Sync_favicon.png', sizes: '512x512', type: 'image/png', purpose: 'any' },
    ],
  }
}
