    ...
    <div className="flex h-dvh bg-gray-50 text-gray-900 dark:bg-gray-950 dark:text-gray-100">
      ...
      <div className="flex-1 transition-all duration-300">
        <div className="flex h-full flex-col">
          ...
          {topbar && (
            <header className="fixed left-0 top-0 z-40 flex h-14 w-full items-center justify-between border-b border-gray-100 bg-white px-6 text-gray-700 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300">
          ...
          >
            <main className="flex min-h-0 flex-1 flex-col overflow-y-auto bg-white dark:bg-gray-900">
